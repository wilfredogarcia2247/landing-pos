...
import imprentaImg from "@/assets/imprenta-integraciones.png";
        ...
        >
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold mb-4">
              Conectado con{" "}
              <span className="text-gradient">Imprentas Digitales</span>
            </h3>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Integración directa con imprentas digitales certificadas para cumplir
              con todos los requisitos fiscales sin complicaciones.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 glass-card rounded-xl p-3 shadow-card"
              >
            ...
            >
              <div className="p-4 rounded-xl bg-card border border-border">
                <h4 className="font-semibold text-lg mb-2">Sincronización Automática</h4>
                <p className="text-muted-foreground">
                  Cada factura se envía automáticamente a la imprenta digital sin intervención manual.
                </p>
              </div>
              
              <div className="p-4 rounded-xl bg-card border border-border">
                <h4 className="font-semibold text-lg mb-2">Validación Inmediata</h4>
                <p className="text-muted-foreground">
                  Verificación en tiempo real del cumplimiento fiscal con el SENIAT.
                </p>
              </div>
              
              <div className="p-4 rounded-xl bg-card border border-border">
                <h4 className="font-semibold text-lg mb-2">Reportes Automáticos</h4>
                <p className="text-muted-foreground">
                  Generación de libros de ventas y reportes Z/X de forma automática.
                </p>
              </div>
            </motion.div>
          </div>
